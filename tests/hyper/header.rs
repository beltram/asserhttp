...
mod eq {
    ...
    async fn should_expect_header() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header("x-a", "a");
    }
    ...
    async fn should_expect_many_header() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap()
            .expect_header("x-a", "a")
            .expect_header("x-b", "b");
    }
    ...
    async fn expect_header_should_panic_when_wrong_key() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header("x-b", "a");
    }
    ...
    async fn expect_header_should_panic_when_wrong_value() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header("x-a", "b");
    }
    ...
    async fn expect_header_should_panic_when_multi_valued() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header("x-m", "a");
    }

    #[tokio::test]
    #[stubr::mock("header/one.json")]
    async fn result_should_expect_header() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header("x-a", "a");
    }

    #[tokio::test]
    #[stubr::mock("header/many.json")]
    async fn result_should_expect_many_header() {
        Client::new().get(stubr.uri().parse().unwrap()).await
            .expect_header("x-a", "a")
            .expect_header("x-b", "b");
    }
    ...
    async fn result_expect_header_should_panic_when_wrong_key() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header("x-b", "a");
    }
    ...
    async fn result_expect_header_should_panic_when_wrong_value() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header("x-a", "b");
    }
    ...
    async fn result_expect_header_should_panic_when_multi_valued() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header("x-m", "a");
    }
}
...
mod multi {
    ...
    async fn expect_headers_should_expect_multi_headers() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-m", ["a", "b"]);
    }
    ...
    async fn expect_headers_should_fail_when_key_missing() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-b", ["a", "b"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_value_missing() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-m", ["a"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_value_not_eq() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-m", ["a", "c"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_expected_value_missing() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-m", ["a", "b", "c"]);
    }
    ...
    async fn expect_headers_should_fail_when_no_value_expected() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_headers("x-m", []);
    }

    #[tokio::test]
    #[stubr::mock("header/multi.json")]
    async fn result_expect_headers_should_expect_multi_headers() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_headers("x-m", ["a", "b"]);
    }
}
...
mod present {
    ...
    async fn should_expect_header_present() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header_present("x-a");
    }
    ...
    async fn expect_header_present_should_fail_when_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header_present("x-b");
    }

    #[tokio::test]
    #[stubr::mock("header/one.json")]
    async fn result_should_expect_header_present() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header_present("x-a");
    }
    ...
    async fn result_expect_header_present_should_fail_when_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header_present("x-b");
    }
}
...
mod absent {
    ...
    async fn should_expect_header_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header_absent("x-b");
    }
    ...
    async fn expect_header_absent_should_fail_when_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_header_absent("x-a");
    }
    ...
    async fn result_should_expect_header_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header_absent("x-b");
    }
    ...
    async fn result_expect_header_absent_should_fail_when_absent() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_header_absent("x-a");
    }
...
mod json {
    ...
    async fn should_expect_content_type_json() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_content_type_json();
    }
    ...
    async fn result_should_expect_content_type_json() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_content_type_json();
    }
...
mod text {
    ...
    async fn should_expect_content_type_text() {
        Client::new().get(stubr.uri().parse().unwrap()).await.unwrap().expect_content_type_text();
    }
    ...
    async fn result_should_expect_content_type_text() {
        Client::new().get(stubr.uri().parse().unwrap()).await.expect_content_type_text();
    }
