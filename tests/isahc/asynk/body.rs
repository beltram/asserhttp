...
mod regex {
    ...
    async fn should_expect_body_text_matches() {
        let srv = Stubr::start("tests/stubs/body/text/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_text_matches("[a-d]+");
    }
    ...
    async fn expect_body_text_matches_should_fail_when_does_not_match_regex() {
        let srv = Stubr::start("tests/stubs/body/text/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_text_matches("[e-h]+");
    }
    ...
    async fn result_should_expect_body_text_matches() {
        let srv = Stubr::start("tests/stubs/body/text/value.json").await;
        get_async(&srv.uri()).await.expect_body_text_matches("[a-d]+");
    }
    ...
    async fn result_expect_body_text_matches_should_fail_when_does_not_match_regex() {
        let srv = Stubr::start("tests/stubs/body/text/value.json").await;
        get_async(&srv.uri()).await.expect_body_text_matches("[e-h]+");
    }
...
mod bytes {
    ...
    async fn should_expect_body_bytes() {
        ...
        get_async(&srv.uri()).await.unwrap().expect_body_bytes(|b| assert_eq!(b, b"abcd"));
    }
    ...
    async fn expect_body_bytes_should_fail_when_closure_fails() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_bytes(|b| assert_eq!(b, b"dcba"));
    }

    #[async_std::test]
    async fn result_should_expect_body_bytes() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.expect_body_bytes(|b| assert_eq!(b, b"abcd"));
    }
    ...
    async fn result_expect_body_bytes_should_fail_when_closure_fails() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.expect_body_bytes(|b| assert_eq!(b, b"dcba"));
    }
}
...
mod bytes_eq {
    ...
    async fn should_expect_body_bytes_eq() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_bytes_eq(b"abcd");
    }
    ...
    async fn expect_body_bytes_should_fail_not_equal() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_bytes_eq(b"dcba");
    }
    ...
    async fn result_should_expect_body_bytes_eq() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.expect_body_bytes_eq(b"abcd");
    }
    ...
    async fn result_expect_body_bytes_should_fail_not_equal() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.expect_body_bytes_eq(b"dcba");
    }
...
mod present {
    ...
    async fn should_expect_body_present() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_present();
    }
    ...
    async fn result_should_expect_body_present() {
        let srv = Stubr::start("tests/stubs/body/bytes/value.json").await;
        get_async(&srv.uri()).await.expect_body_present();
    }
...
mod absent {
    ...
    async fn should_expect_body_absent() {
        let srv = Stubr::start("tests/stubs/body/bytes/absent.json").await;
        get_async(&srv.uri()).await.unwrap().expect_body_absent();
    }
    ...
    async fn result_should_expect_body_absent() {
        let srv = Stubr::start("tests/stubs/body/bytes/absent.json").await;
        get_async(&srv.uri()).await.expect_body_absent();
    }
