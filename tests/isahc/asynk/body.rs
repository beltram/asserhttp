...
mod json {
    ...
    async fn should_expect_raw_body_json() {
        get_async(stubr.uri()).await.unwrap().expect_body_json(|b: Value| assert_eq!(b, json!({"a": "b"})));
    }

    #[async_std::test]
    #[stubr::mock("body/json/value.json")]
    async fn should_expect_struct_body_json() {
        get_async(stubr.uri()).await.unwrap().expect_body_json(|b: Body| assert_eq!(b, Body { a: String::from("b") }));
    }
    ...
    async fn expect_body_json_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.unwrap().expect_body_json(|b: Value| assert_eq!(b, json!({"a": "c"})));
    }

    #[async_std::test]
    #[stubr::mock("body/json/value.json")]
    async fn result_should_expect_raw_body_json() {
        get_async(stubr.uri()).await.expect_body_json(|b: Value| assert_eq!(b, json!({"a": "b"})));
    }

    #[async_std::test]
    #[stubr::mock("body/json/value.json")]
    async fn result_should_expect_struct_body_json() {
        get_async(stubr.uri()).await.expect_body_json(|b: Body| assert_eq!(b, Body { a: String::from("b") }));
    }
    ...
    async fn result_expect_body_json_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.expect_body_json(|b: Value| assert_eq!(b, json!({"a": "c"})));
    }
}
...
mod json_eq {
    ...
    #[stubr::mock("body/json/value.json")]
    async fn should_expect_raw_body_json() {
        get_async(stubr.uri()).await.unwrap().expect_body_json_eq(json!({"a": "b"}));
    }

    #[async_std::test]
    #[stubr::mock("body/json/value.json")]
    async fn should_expect_struct_body_json() {
        get_async(stubr.uri()).await.unwrap().expect_body_json_eq(Body { a: String::from("b") });
    }
    ...
    async fn expect_body_json_should_fail_when_not_equal() {
        get_async(stubr.uri()).await.unwrap().expect_body_json_eq(json!({"a": "c"}));
    }
    ...
    #[stubr::mock("body/json/value.json")]
    async fn result_should_expect_raw_body_json() {
        get_async(stubr.uri()).await.expect_body_json_eq(json!({"a": "b"}));
    }

    #[async_std::test]
    #[stubr::mock("body/json/value.json")]
    async fn result_should_expect_struct_body_json() {
        get_async(stubr.uri()).await.expect_body_json_eq(Body { a: String::from("b") });
    }
    ...
    async fn result_expect_body_json_should_fail_when_not_equal() {
        get_async(stubr.uri()).await.expect_body_json_eq(json!({"a": "c"}));
    }
...
mod text {
    ...
    async fn should_expect_body_text() {
        get_async(stubr.uri()).await.unwrap().expect_body_text(|b| assert_eq!(b, String::from("abcd")));
    }
    ...
    async fn expect_body_text_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.unwrap().expect_body_text(|b| assert_eq!(b, String::from("dcba")));
    }

    #[async_std::test]
    #[stubr::mock("body/text/value.json")]
    async fn result_should_expect_body_text() {
        get_async(stubr.uri()).await.expect_body_text(|b| assert_eq!(b, String::from("abcd")));
    }
    ...
    async fn result_expect_body_text_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.expect_body_text(|b| assert_eq!(b, String::from("dcba")));
    }
}
...
mod text_eq {
    ...
    async fn should_expect_body_text_eq() {
        get_async(stubr.uri()).await.unwrap().expect_body_text_eq("abcd");
    }
    ...
    async fn expect_body_text_should_fail_when_not_equal() {
        get_async(stubr.uri()).await.unwrap().expect_body_text_eq("dcab");
    }
    ...
    async fn result_should_expect_body_text_eq() {
        get_async(stubr.uri()).await.expect_body_text_eq("abcd");
    }
    ...
    async fn result_expect_body_text_should_fail_when_not_equal() {
        get_async(stubr.uri()).await.expect_body_text_eq("dcab");
    }
...
mod regex {
    ...
    async fn should_expect_body_text_matches() {
        get_async(stubr.uri()).await.unwrap().expect_body_text_matches("[a-d]+");
    }
    ...
    async fn expect_body_text_matches_should_fail_when_does_not_match_regex() {
        get_async(stubr.uri()).await.unwrap().expect_body_text_matches("[e-h]+");
    }
    ...
    async fn result_should_expect_body_text_matches() {
        get_async(stubr.uri()).await.expect_body_text_matches("[a-d]+");
    }
    ...
    async fn result_expect_body_text_matches_should_fail_when_does_not_match_regex() {
        get_async(stubr.uri()).await.expect_body_text_matches("[e-h]+");
    }
...
mod bytes {
    ...
    async fn should_expect_body_bytes() {
        get_async(stubr.uri()).await.unwrap().expect_body_bytes(|b| assert_eq!(b, b"abcd"));
    }
    ...
    async fn expect_body_bytes_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.unwrap().expect_body_bytes(|b| assert_eq!(b, b"dcba"));
    }

    #[async_std::test]
    #[stubr::mock("body/bytes/value.json")]
    async fn result_should_expect_body_bytes() {
        get_async(stubr.uri()).await.expect_body_bytes(|b| assert_eq!(b, b"abcd"));
    }
    ...
    async fn result_expect_body_bytes_should_fail_when_closure_fails() {
        get_async(stubr.uri()).await.expect_body_bytes(|b| assert_eq!(b, b"dcba"));
    }
}
...
mod bytes_eq {
    ...
    async fn should_expect_body_bytes_eq() {
        get_async(stubr.uri()).await.unwrap().expect_body_bytes_eq(b"abcd");
    }
    ...
    async fn expect_body_bytes_should_fail_not_equal() {
        get_async(stubr.uri()).await.unwrap().expect_body_bytes_eq(b"dcba");
    }
    ...
    async fn result_should_expect_body_bytes_eq() {
        get_async(stubr.uri()).await.expect_body_bytes_eq(b"abcd");
    }
    ...
    async fn result_expect_body_bytes_should_fail_not_equal() {
        get_async(stubr.uri()).await.expect_body_bytes_eq(b"dcba");
    }
...
mod present {
    ...
    async fn should_expect_body_present() {
        get_async(stubr.uri()).await.unwrap().expect_body_present();
    }
    ...
    async fn result_should_expect_body_present() {
        get_async(stubr.uri()).await.expect_body_present();
    }
...
mod absent {
    ...
    async fn should_expect_body_absent() {
        get_async(stubr.uri()).await.unwrap().expect_body_absent();
    }
    ...
    async fn result_should_expect_body_absent() {
        get_async(stubr.uri()).await.expect_body_absent();
    }
