...
mod ok {
    ...
    async fn should_expect_status_ok() {
        get_async(stubr.uri()).await.unwrap().expect_status_ok();
    }
    ...
    async fn result_should_expect_status_ok() {
        get_async(stubr.uri()).await.expect_status_ok();
    }
...
mod created {
    ...
    async fn should_expect_status_created() {
        get_async(stubr.uri()).await.unwrap().expect_status_created();
    }
    ...
    async fn result_should_expect_status_created() {
        get_async(stubr.uri()).await.expect_status_created();
    }
...
mod accepted {
    ...
    async fn should_expect_status_accepted() {
        get_async(stubr.uri()).await.unwrap().expect_status_accepted();
    }
    ...
    async fn result_should_expect_status_accepted() {
        get_async(stubr.uri()).await.expect_status_accepted();
    }
...
mod no_content {
    ...
    async fn should_expect_status_no_content() {
        get_async(stubr.uri()).await.unwrap().expect_status_no_content();
    }
    ...
    async fn result_should_expect_status_no_content() {
        get_async(stubr.uri()).await.expect_status_no_content();
    }
...
mod partial_content {
    ...
    async fn should_expect_status_partial_content() {
        get_async(stubr.uri()).await.unwrap().expect_status_partial_content();
    }
    ...
    async fn result_should_expect_status_partial_content() {
        get_async(stubr.uri()).await.expect_status_partial_content();
    }
...
mod bad_request {
    ...
    async fn should_expect_status_bad_request() {
        get_async(stubr.uri()).await.unwrap().expect_status_bad_request();
    }
    ...
    async fn result_should_expect_status_bad_request() {
        get_async(stubr.uri()).await.expect_status_bad_request();
    }
...
mod unauthorized {
    ...
    async fn should_expect_status_unauthorized() {
        get_async(stubr.uri()).await.unwrap().expect_status_unauthorized();
    }
    ...
    async fn result_should_expect_status_unauthorized() {
        get_async(stubr.uri()).await.expect_status_unauthorized();
    }
...
mod forbidden {
    ...
    async fn should_expect_status_forbidden() {
        get_async(stubr.uri()).await.unwrap().expect_status_forbidden();
    }
    ...
    async fn result_should_expect_status_forbidden() {
        get_async(stubr.uri()).await.expect_status_forbidden();
    }
...
mod not_found {
    ...
    async fn should_expect_status_not_found() {
        get_async(stubr.uri()).await.unwrap().expect_status_not_found();
    }
    ...
    async fn result_should_expect_status_not_found() {
        get_async(stubr.uri()).await.expect_status_not_found();
    }
...
mod conflict {
    ...
    async fn should_expect_status_conflict() {
        get_async(stubr.uri()).await.unwrap().expect_status_conflict();
    }
    ...
    async fn result_should_expect_status_conflict() {
        get_async(stubr.uri()).await.expect_status_conflict();
    }
...
mod gone {
    ...
    async fn should_expect_status_gone() {
        get_async(stubr.uri()).await.unwrap().expect_status_gone();
    }
    ...
    async fn result_should_expect_status_gone() {
        get_async(stubr.uri()).await.expect_status_gone();
    }
...
mod internal_server_error {
    ...
    async fn should_expect_status_internal_server_error() {
        get_async(stubr.uri()).await.unwrap().expect_status_internal_server_error();
    }
    ...
    async fn result_should_expect_status_internal_server_error() {
        get_async(stubr.uri()).await.expect_status_internal_server_error();
    }
...
mod range {
    ...
    async fn should_expect_status_in_inclusive_lower_range() {
        get_async(stubr.uri()).await.unwrap().expect_status_in_range(201, 300);
    }

    #[async_std::test]
    #[stubr::mock("status/created.json")]
    async fn should_expect_status_in_exclusive_upper_range() {
        get_async(stubr.uri()).await.unwrap().expect_status_in_range(200, 202);
    }
    ...
    async fn expect_status_in_range_should_panic_when_lower() {
        get_async(stubr.uri()).await.unwrap().expect_status_in_range(202, 300);
    }
    ...
    async fn expect_status_in_range_should_panic_when_upper() {
        get_async(stubr.uri()).await.unwrap().expect_status_in_range(200, 201);
    }

    #[async_std::test]
    #[stubr::mock("status/created.json")]
    async fn result_should_expect_status_in_inclusive_lower_range() {
        get_async(stubr.uri()).await.expect_status_in_range(201, 300);
    }

    #[async_std::test]
    #[stubr::mock("status/created.json")]
    async fn result_should_expect_status_in_exclusive_upper_range() {
        get_async(stubr.uri()).await.expect_status_in_range(200, 202);
    }
    ...
    async fn result_expect_status_in_range_should_panic_when_lower() {
        get_async(stubr.uri()).await.expect_status_in_range(202, 300);
    }
    ...
    async fn result_expect_status_in_range_should_panic_when_upper() {
        get_async(stubr.uri()).await.expect_status_in_range(200, 201);
    }
}
...
mod success {
    ...
    async fn should_expect_status_success() {
        get_async(stubr.uri()).await.unwrap().expect_status_success();
    }
    ...
    async fn result_should_expect_status_success() {
        get_async(stubr.uri()).await.expect_status_success();
    }
...
mod redirection {
    ...
    async fn should_expect_status_redirection() {
        get_async(stubr.uri()).await.unwrap().expect_status_redirection();
    }
    ...
    async fn result_should_expect_status_redirection() {
        get_async(stubr.uri()).await.expect_status_redirection();
    }
...
mod client_error {
    ...
    async fn should_expect_status_client_error() {
        get_async(stubr.uri()).await.unwrap().expect_status_client_error();
    }
    ...
    async fn result_should_expect_status_client_error() {
        get_async(stubr.uri()).await.expect_status_client_error();
    }
...
mod server_error {
    ...
    async fn should_expect_status_server_error() {
        get_async(stubr.uri()).await.unwrap().expect_status_server_error();
    }
    ...
    async fn result_should_expect_status_server_error() {
        get_async(stubr.uri()).await.expect_status_server_error();
    }
