use rocket::{get, http::Header, local::asynchronous::Client, Request, Response, response::Responder, routes};
...
mod eq {
    ...
    async fn should_expect_header() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header("x-a", "a");
    }
    ...
    async fn should_expect_many_header() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![xaxb])).await.unwrap();
    ...
    async fn expect_header_should_panic_when_wrong_key() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header("x-b", "a");
    }
    ...
    async fn expect_header_should_panic_when_wrong_value() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header("x-a", "b");
    }
    ...
    async fn expect_header_should_panic_when_multi_valued() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_header("x-m", "a");
    }
}
...
mod multi {
    ...
    async fn expect_headers_should_expect_multi_headers() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-m", ["a", "b"]);
    }
    ...
    async fn expect_headers_should_fail_when_key_missing() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-b", ["a", "b"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_value_missing() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-m", ["a"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_value_not_eq() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-m", ["a", "c"]);
    }
    ...
    async fn expect_headers_should_fail_when_one_expected_value_missing() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-m", ["a", "b", "c"]);
    }
    ...
    async fn expect_headers_should_fail_when_no_value_expected() {
        ...
        fn xm() -> Resp { Resp(vec![("x-m", vec!["a", "b"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xm])).await.unwrap();
        client.get("/").dispatch().await.expect_headers("x-m", []);
    }
}
...
mod present {
    ...
    async fn should_expect_header_present() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header_present("x-a");
    }
    ...
    async fn expect_header_present_should_fail_when_absent() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header_present("x-b");
    }
}
...
mod absent {
    ...
    async fn should_expect_header_absent() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header_absent("x-b");
    }
    ...
    async fn expect_header_absent_should_fail_when_absent() {
        ...
        fn xa() -> Resp { Resp(vec![("x-a", vec!["a"])]) }
        let client = Client::tracked(rocket::build().mount("/", routes![xa])).await.unwrap();
        client.get("/").dispatch().await.expect_header_absent("x-a");
    }
...
mod json {
    ...
    async fn should_expect_content_type_json() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![json])).await.unwrap();
        client.get("/").dispatch().await.expect_content_type_json();
    }
    ...
    async fn expect_header_should_panic_when_wrong_value() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![xml])).await.unwrap();
        client.get("/").dispatch().await.expect_content_type_json();
    }
}
...
mod text {
    ...
    async fn should_expect_content_type_text() {
        ...
        let client = Client::tracked(rocket::build().mount("/", routes![text])).await.unwrap();
        client.get("/").dispatch().await.expect_content_type_text();
    }
